(function() {
  ...
  function configRoutes($stateProvider, $urlRouterProvider, mediaService) {
    ...
    $stateProvider
      .state('Home', {
        url: '/',
        templateUrl: 'src/client/app/landing/landing.html'
      })
      .state('120mm', {
        url: '/120mm',
        templateUrl: 'src/client/app/portfolio/portfolio.html',
        controller: '120mm',
        controllerAs: 'vm'
      })
      ...
      .state('Digital', {
        url: '/digital',
        templateUrl: 'src/client/app/digital/digital.html',
        controller: 'Digital',
        controllerAs: 'vm'
      })
      .state('DigitalIphone', {
      ...
      .state('Connection', {
        url: '/connection',
        templateUrl: 'src/client/app/connection/connection.html',
        controller: 'Connection',
        controllerAs: 'vm'
      })
      .state('Registration', {
        url: '/registration',
        templateUrl: 'src/client/app/registration/registration.html',

(function() {
    ...
    filmShort.$inject = ['MediaService', 'Preloader', 'CommentService', '$window'];

    function filmShort(MediaService, Preloader, CommentService, $window) {
        ...
        function getPictures() {
            vm.pictures = media.filter(function(media) {
                return (media.medium_type === 'Film' && media.medium_spec === 'Short');
            });
        }
